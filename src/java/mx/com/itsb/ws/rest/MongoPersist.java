...
import fe.db.mongo.MongoJsonDao;
 ...
 * @author CarloGS
 */
@Path("mongo/{uuid}") //Especificamos una ruta que se debe usar para invocar este método y un parámetro (tipo)
public class MongoPersist {
