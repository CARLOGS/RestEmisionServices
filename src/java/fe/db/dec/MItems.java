...
@NamedQueries({
    ...
    @NamedQuery(name = "MItems.findAllId", query = "SELECT m FROM MItems m WHERE m.id = :id"),
    @NamedQuery(name = "MItems.findAllTipoId", query = "SELECT m FROM MItems m WHERE m.tipo = :tipo AND m.id IN :id"),
    @NamedQuery(name = "MItems.findAllNDescripcion", query = "SELECT m FROM MItems m WHERE m.descripcion LIKE :descripcion ")
})
