 ...
 */
@Entity
@Table(name="LICENCIAS_HIS", uniqueConstraints = {@UniqueConstraint(columnNames={"RFC"})})
public class MLicenciaHis implements Serializable {
    ...
    protected MLicenciaHis() {}

    public MLicenciaHis(String rfc, byte[] lic, Date fecha, Date inicia, Date vence, String tipo) {
            this.rfc = rfc;
            this.lic = lic;
            this.fecha = fecha;
            this.inicia = inicia;
