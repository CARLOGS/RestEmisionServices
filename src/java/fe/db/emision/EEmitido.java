 ...
 */
@Entity
@Table(name = "E_EMITIDO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EEmitido.findAll", query = "SELECT m FROM EEmitido m"),
    @NamedQuery(name = "EEmitido.findAllN", query = "SELECT m FROM EEmitido m WHERE m.clientes = :clientes"),
    @NamedQuery(name = "EEmitido.findAllId", query = "SELECT m FROM EEmitido m WHERE m.id = :id")
})
public class EEmitido implements Serializable {
    ...
    public EEmitido(String nombre, String calle, String cp, String pais, EClientes clientes) {
        this.nombre = nombre;
        this.calle = calle;
        this.cp = cp;
        this.pais = pais;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EEmitido)) {
            return false;
        }
        EEmitido other = (EEmitido) object;
